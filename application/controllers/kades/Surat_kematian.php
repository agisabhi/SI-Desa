...
class Surat_kematian extends CI_Controller {
	...
	public function __construct()
  {
	...
	public function index()
	{
        ...
        $data['pengajuan'] = $this->adminkelahiran_model->data_kematian_kades();
        
        
		$this->load->view('header/headerstaff',$data);
		$this->load->view('kades/sidebar_lahir');
		$this->load->view('kades/surat_kematian',$data);
	...
	public function detail_kematian($id){
        ...
        $this->load->view('header/headerstaff',$data);
		$this->load->view('kades/sidebar_lahir');
		$this->load->view('kades/detail_kematian',$data);
		$this->load->view('footer/footerstaff');
    ...
    public function laporan(){
      ...
      $data['url']= 'admin/surat_kematian/cetak?awal='.$data['awal'].'&akhir='.$data['akhir'];
		...
		$this->load->view('kades/laporan_kematian',$data);
		$this->load->view('footer/footerstaff');
