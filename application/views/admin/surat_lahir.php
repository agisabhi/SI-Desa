                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="country-floating" class="form-control"
                                                name="alamat" placeholder="Alamat" value="Desa Tanjung Setia Kec. Pesisir Selatan Kab. Pesisir Barat">
                    ...
                    <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               ...
                               <input type="hidden" value="<?=$p['id_lahir'];?>" name="id_lahir">
                               <br><?php if($p['status']=="menunggu"){?>
                                <a href="<?=base_url();?>admin/surat_lahir/detail/<?=$p['id_lahir'];?>" class="btn btn-primary">Detail</a>
                                <?php }else if ($p['status']=="acc_kades") {
                                        ?><a href="<?= base_url(); ?>admin/cetak_surat/index/<?=$p['id_lahir']; ?>" class="btn btn-success">Unduh</a><?php
                                    }else if($p['status']=="siap_ambil"){
                                        ?><a href="<?= base_url(); ?>admin/surat_lahir/ambil/<?=$p['id_lahir']; ?>" class="btn btn-success">Ambil Surat</a><?php
                                    }else{
