...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?=base_url();?>admin/surat_datang/tambah" class="btn btn-outline-primary"><i class="bi bi-plus"></i> Tambah Pengajuan</a>  
            ...
            ?>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <label for="provinsi">Provinsi</label>
                                                <select id="" name="prov_now" class="form-control select2" readonly>
                                                    <option value="Lampung" selected>Lampung</option>
                                                </select> <br>
                                            <label for="kabupaten">Kabupaten</label>
                                                <select id="" name="kab_now" class="form-control select2" readonly>
                                                    <option value="Pesisir Barat" selected>Pesisir Barat</option>
                                                </select> <br>
                                            <label for="kecamatan">Kecamatan</label>
                                                <select id="" name="kec_now" class="form-control select2" readonly>
                                                    <option value="Pesisir Selatan" selected>Pesisir Selatan</option>
                                                </select> <br>
                                            <label for="kelurahan">Kelurahan</label>
                                                <select id="" name="kel_now" class="form-control select2" readonly>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               <form class="form" action="<?=base_url();?>admin/surat_datang/validasi" method="post">
                               
                               
                               <input type="hidden" value="<?=$p['id_datang'];?>" name="id_kematian">
                               <br><?php if($p['status']=="menunggu"){?>
                                <a href="<?=base_url();?>admin/surat_datang/detail_datang/<?=$p['id_datang'];?>" class="btn btn-primary">Detail</a>
                                <?php }else if ($p['status']=="acc_kades") {
                                        ?><a href="<?= base_url(); ?>admin/cetak_surat/datang/<?=$p['id_datang']; ?>" class="btn btn-success">Unduh</a><?php
                                    }else if($p['status']=="siap_ambil"){
                                        ?><a href="<?= base_url(); ?>admin/surat_datang/ambil/<?=$p['id_datang']; ?>" class="btn btn-success">Ambil Surat</a><?php
                                    }else{
    ...
    <script type="text/javascript">
        ...
        $("#provinsi").change(function() {
            ...
            $("#kabupaten").select2({
                ajax: {
                    url: '<?= base_url() ?>admin/combobox/getdatakab/' + id_prov,
                    type: "post",
                    dataType: 'json',
                    delay: 200,
                    data: function(params) {
        ...
        $("#kabupaten").change(function() {
            ...
            $("#kecamatan").select2({
                ajax: {
                    url: '<?= base_url() ?>admin/combobox/getdatakec/' + id_kab,
                    type: "post",
                    dataType: 'json',
                    delay: 200,
                    data: function(params) {
        ...
        $("#kecamatan").change(function() {
            ...
            $("#kelurahan").select2({
                ajax: {
                    url: '<?= base_url() ?>admin/combobox/getdatakel/' + id_kac,
                    type: "post",
                    dataType: 'json',
                    delay: 200,
                    data: function(params) {
