                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                     ...
                                     <input type="hidden" id="first-name-column" class="form-control"
                                                placeholder="alamat" name="alamat" value="Desa Tanjung Setia Kecamatan Pesisisr Selatan Kabupaten Pesisir Barat">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               <form class="form" action="<?=base_url();?>admin/surat_lahir/validasi" method="post">
                               
                               
                               <input type="hidden" value="<?=$p['id_kematian'];?>" name="id_kematian">
                               <br><?php if($p['status']=="menunggu"){?>
                                <a href="<?=base_url();?>admin/surat_kematian/detail_kematian/<?=$p['id_kematian'];?>" class="btn btn-primary">Detail</a>
                                <?php }else if ($p['status']=="acc_kades") {
                                        ?><a href="<?= base_url(); ?>admin/cetak_surat/kematian/<?=$p['id_kematian']; ?>" class="btn btn-success">Unduh</a><?php
                                    }else if($p['status']=="siap_ambil"){
                                        ?><a href="<?= base_url(); ?>admin/surat_kematian/ambil/<?=$p['id_kematian']; ?>" class="btn btn-success">Ambil Surat</a><?php
                                    }else{
