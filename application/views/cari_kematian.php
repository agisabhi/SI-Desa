...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="<?=base_url();?>welcome">Home</a></li>
			<li class="active">Cari Surat Kematian</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Cari Pengajuan Surat Kematian</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Cari Data Pengajuan Surat Kematian</h3>
							...
							<form action="<?=base_url();?>welcome/hasil_kematian" method="post">
								<div class="top-margin">
									<label>No Surat<span class="text-danger"></span></label>
									<input type="text" class="form-control" name="no_surat_kematian">
								</div>
								<br>
								<div class="row">
