...
<body class="home">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="<?=base_url();?>welcome/cari_kematian">Surat Keterangan Kematian</a></li>
							<li class="active"><a href="<?=base_url();?>welcome/cari_datang">Surat Keterangan Pindah Datang</a></li>
						</ul>
					</li>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="<?=base_url();?>welcome">Home</a></li>
			<li class="active">Cari Surat Pindah Datang</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Cari Pengajuan Surat Pindah Datang</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Cari Data Pengajuan Surat Pindah Datang</h3>
							...
							<form action="<?=base_url();?>welcome/hasil_datang" method="post">
								<div class="top-margin">
									<label>No Surat<span class="text-danger"></span></label>
									<input type="text" class="form-control" name="no_surat_datang">
								</div>
								<br>
								<div class="row">
