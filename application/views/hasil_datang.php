		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				<header class="page-header">
					<h1 class="page-title">Cari Pengajuan Surat Datang</h1>
				</header>
				...
				<form action="<?=base_url();?>welcome/hasil_datang" method="post">
					<div class="row">
						<div class="col-sm-4">
							<label >No Surat Datang</label>
							<input class="form-control" name="no_surat_datang" type="text" placeholder="Masukkan No Surat">
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-6 text-left">
							<br>
							<input class="btn btn-action" type="submit" value="Cari">
