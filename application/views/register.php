	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="<?=base_url();?>assets/Progressus/assets/images/logoedit.png" alt="Progressus HTML5 template"></a>
			</div>
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a class="btn" href="<?=base_url();?>login">SIGN IN / SIGN UP</a></li>
				</ul>
			</div><!--/.nav-collapse -->
		</div>
	</div> 
							...
							<form action="<?=base_url();?>register/tambah" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-right">
										<p>Sudah Memiliki Akun? Silahkan <a href="<?=base_url();?>login">Login</a></p>
									</div>
