    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Pengajuan Surat Pindah Datang</h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Surat Pindah Datang</li>
                    </ol>
                </nav>
            </div>
        </div>
															...
															<div class="modal-content">
																<div class="modal-header bg-primary">
																	<h5 class="modal-title white" id="myModalLabel160">
																		Validasi Pengajuan Surat Pindah Datang
																	</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="first-name-column" class="form-control"
                                                placeholder="No KK" name="no_kk" value=<?=$surat_kematian['no_kk'];?> readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <label for="provinsi">Provinsi</label>
                                                <select id="prov" name="provinsi" class="form-control" readonly>
                                                   <option value="<?=$surat_kematian['id_prov_asal'];?>"><?=$surat_kematian['nama_prov'];?></option>
                                                </select> <br>
                                            <label for="kabupaten">Kabupaten</label>
                                                <select id="kabu" name="kabupaten" class="form-control " readonly>
                                                    <option value="<?=$surat_kematian['id_kab_asal'];?>"><?=$surat_kematian['nama_kab'];?></option>
                                                     
                                                    
                                                </select> <br>
                                            <label for="kecamatan">Kecamatan</label>
                                                <select id="kecam" name="kecamatan" class="form-control " readonly>
                                                                                                   <option value="<?=$surat_kematian['id_kec_asal'];?>"><?=$surat_kematian['nama_kec'];?></option> 
                                                </select> <br>
                                            <label for="kelurahan">Kelurahan</label>
                                                <select id="kel" name="kelurahan" class="form-control " readonly>
                                                                                                       <option value="<?=$surat_kematian['id_kel_asal'];?>"><?=$surat_kematian['nama_kel'];?></option>
                                                </select> <br>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pekerjaan" class="form-control" placeholfer="Pekerjaan" value="<?=$surat_kematian['pekerjaan'];?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_kematian['foto_sp'];?>" width="800px">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
...
<br>
                                    ...
                                    <div class="col-12 d-flex justify-content-start"  align="left">
                                        ...
                                        <a href="<?=base_url();?>kades/surat_datang" class="btn btn-danger me-1 mb-1">Kembali</a>
                                    </div>
                                </div>
                            </form>
            </div>
