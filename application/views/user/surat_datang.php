    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?=base_url();?>user/surat_datang/tambah" class="btn btn-outline-primary"><i class="bi bi-plus"></i> Tambah Pengajuan</a>  
                    ...
                    <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               ...
                               <input type="hidden" value="<?=$p['id_datang'];?>" name="id_datang">
                               <br><?php if($p['status']=="menunggu" || $p['status']=="ditolak" ){?>
                                <a href="<?=base_url();?>user/surat_datang/edit/<?=$p['id_datang'];?>" class="btn btn-primary">Edit</a>
                                <?php }else{?>
