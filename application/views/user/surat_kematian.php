                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form" action="<?=base_url();?>user/surat_kematian/tambah" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <input type="hidden" id="first-name-column" class="form-control"
                                        placeholder="alamat" name="alamat" value="Desa Tanjung Setia Kecamatan Pesisir Selatan Kabupaten Pesisir Barat">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Foto KTP Almarhum (jika > 17 th)</label>
                       ...
                       <tr>
                           ...
                           <td>
                               ...
                               <br><?php if($p['status']=="menunggu" || $p['status']=="ditolak"){?>
                                <a href="<?=base_url();?>user/surat_kematian/edit_kematian/<?=$p['id_kematian'];?>" class="btn btn-primary">Ubah</a>
                                <?php }else{?>
