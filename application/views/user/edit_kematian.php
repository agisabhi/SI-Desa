    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Ubah Pengajuan Surat Kelahiran</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="Nama Lengkap" name="bin" value="<?=$surat_kematian['bin'];?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="alamat" name="alamat" value="<?=$surat_kematian['alamat'];?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="last-name-column" class="form-control"
                                                placeholder="Tanggal Lahir" name="tanggal_lahir" value="<?=$surat_kematian['tanggal_lahir'];?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="country-floating" class="form-control"
                                                name="tanggal_kematian" placeholder="" value="<?=$surat_kematian['tanggal_kematian'];?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="time" id="company-column" class="form-control"
                                                name="jam" placeholder="Jam" value="<?=$surat_kematian['jam'];?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="tempat" placeholder="Tempat" value="<?=$surat_kematian['tempat'];?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="sebab" placeholder="Penyebab Meninggal" value="<?=$surat_kematian['sebab'];?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_kematian['foto_ktp'];?>" width="500px" height="400px">
                                            <input type="file" name="foto_ktp" class="form-control">
                                            <input type="hidden" name="foto_ktp_awal" class="form-control" value="<?=$surat_kematian['foto_ktp'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Foto Kartu Keluarga</label><br>
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_kematian['foto_kk'];?>" width="500px" height="400px">
                                            <input type="file" name="foto_kk" class="form-control">
                                            <input type="hidden" name="foto_kk_awal" class="form-control" value="<?=$surat_kematian['foto_kk'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php if($surat_kematian['foto_sk']!=''){ ?>
                                                <img src="<?=base_url();?>assets/foto/<?=$surat_kematian['foto_sk'];?>" width="500px" height="400px"><?php
                                            }else{ ?>
                                                   -- <?php
                                            }
                                            ...
                                            <input type="hidden" name="foto_sk_awal" class="form-control" value="<?=$surat_kematian['foto_sk'];?>">
                                            <input type="hidden" name="id_kematian" class="form-control" value="<?=$surat_kematian['id_kematian'];?>">
                                        </div>
                                    </div>
                                    
                                    <input type="hidden" name="id_kematian" value="<?=$surat_kematian['id_kematian'];?>">
                                    <div class="col-12 d-flex justify-content-end">
                                        <a href="<?=base_url();?>user/surat_kematian" class="btn btn-danger me-1 mb-1">Kembali</a>  
