                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="Nama Lengkap" name="nama" value="<?=$surat_lahir['nama'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column" class="form-control"
                                                placeholder="Tempat Lahir" name="tempat_lahir" value="<?=$surat_lahir['tempat_lahir'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="city-column" class="form-control" placeholder="Tanggal Lahir"
                                                name="tanggal_lahir" value="<?=$surat_lahir['tanggal_lahir'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control"
                                                name="alamat" placeholder="Alamat" value="<?=$surat_lahir['alamat'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nik_ayah" placeholder="Nama Ayah" value="<?=$surat_lahir['nik_ayah'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nama_ayah" placeholder="Nama Ayah" value="<?=$surat_lahir['nama_ayah'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nik_ayah" placeholder="Nama Ayah" value="<?=$surat_lahir['nik_ibu'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="nama_ibu" placeholder="Nama Ibu" value="<?=$surat_lahir['nama_ibu'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="email-id-column" class="form-control"
                                                name="anak_ke" placeholder="Anak-ke" value="<?=$surat_lahir['anak_ke'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Foto KTP Ayah</label><br>
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_lahir['foto_ktp_ayah'];?>" width="500px" height="300px">
                                            <input type="file" id="email-id-column" class="form-control"
                                                name="foto_ktp_ayah" placeholder="Anak-ke" >
                                                <input type="hidden" name="file_ktp_ayah" value="<?=$surat_lahir['foto_ktp_ayah'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_lahir['foto_ktp_ibu'];?>" width="500px" height="300px">
                                            <input type="file" id="email-id-column" class="form-control"
                                                name="foto_ktp_ibu" placeholder="Anak-ke" >
                                                <input type="hidden" name="file_ktp_ibu" value="<?=$surat_lahir['foto_ktp_ibu'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_lahir['foto_kk'];?>" width="500px" height="300px">
                                            <input type="file" id="email-id-column" class="form-control"
                                                name="foto_kk" placeholder="Anak-ke" >
                                                <input type="hidden" name="file_kk" value="<?=$surat_lahir['foto_kk'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Foto Surat Kelahiran Klinik</label><br>
                                            <img src="<?=base_url();?>assets/foto/<?=$surat_lahir['foto_sk'];?>" width="500px" height="300px">
                                            <input type="file" id="email-id-column" class="form-control"
                                                name="foto_sk" placeholder="Anak-ke" >
                                                <input type="hidden" name="file_sk" value="<?=$surat_lahir['foto_sk'];?>">
                                        </div>
                                    </div>
                                    
                                    <div class="col-12 d-flex justify-content-end">
                                        <a href="<?=base_url();?>user/surat_lahir" class="btn btn-danger me-1 mb-1">Kembali</a>  
